  ...
  return (
    <section className="relative min-h-screen bg-black overflow-hidden pt-16 md:px-6">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 justify-center py-8 w-full">
          <StarBorder
            as="button"
            className="w-full sm:w-auto px-6 py-2 cursor-pointer transition-transform duration-200 hover:scale-105 active:scale-95"
            color="#ff00ff"
            speed="5s"
          >
            My Works
